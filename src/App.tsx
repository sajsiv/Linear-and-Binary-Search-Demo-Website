  ...
  return (
    <>
      <div className="container">
        ...
        <button
          onClick={() => alert(linearSearch(dict, search))}
          className="button-9"
        >
          Linear Search
        </button>
        <button
          onClick={() => alert(BinarySearch(dict, search))}
          className="button-9"
        >
          Binary Search
        </button>
      ...
      <div className="imgcontainer">
        <a href="https://github.com/sajsiv/LinBin" target="_blank">
          <img
        ...
        <a href="https://www.youtube.com/watch?v=6_ipZYav8zY" target="_blank">
          <img
